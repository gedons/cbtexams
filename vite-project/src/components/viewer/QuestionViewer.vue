<template>
    <fieldset class="mb-4">
        <div>
            <legend class="text-base font-meduim text-gray-900">
        ...
        <div class="mt-3">
            <div v-if="question.type === 'select'">
                <select 
                  ...
                  class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-m
            ...
            <div v-else-if="question.type === 'radio'">
                ...
                <label
                    :for="option.uuid"
                    class="ml-3 block text-sm font-meduim text-gray-700"
                >
                    {{option.text}}
                </label>
                </div>
